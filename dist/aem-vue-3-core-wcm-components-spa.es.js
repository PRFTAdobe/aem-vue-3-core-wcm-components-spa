...
const Ne = {
    ...
    return ($, C) => {
      ...
      return s(), c("div", {
        ...
        (w = e.elementsOrder) != null && w.length ? (s(), c("div", {
          ...
          (s(!0), c(B, null, D(e.elementsOrder, (p, x) => (s(), c("div", {
            key: `${e.id}-element-${p}-${x}`,
  ...
  setup(t) {
    ...
    return (b, $) => l.value ? g("", !0) : (s(), h(N(f.value), A(P({ key: 0 }, { ...e, ...y(a) })), null, 16));
  }
}), U = {
...
}, Ce = ["id", "data-cmp-single-expansion"], _e = ["id", "data-cmp-expanded"], ye = ["id", "aria-controls", "data-cmp-button-id", "onClick", "onKeydown"], he = /* @__PURE__ */ v("svg", {
  ...
  /* @__PURE__ */ v("path", { d: "M16.59 8.59 12 13.17 7.41 8.59 6 10l6 6 6-6z" })
], -1), fe = [
  he
  ...
  setup(t) {
    const e = t, a = K(), l = M("isInEditor", G.isInEditor()), f = M("componentMapping", new T()), b = F(U.initMessageChannel()), $ = F(-1), C = F(e.expandedItems), w = F(null), p = r(() => (a == null ? void 0 : a.singleExpansion) === !0), x = r(() => {
      const n = {};
    ...
    return le(() => {
      ...
      e.cqItemsOrder && (e == null ? void 0 : e.cqItemsOrder.length) > 0 && e.cqItems ? (s(!0), c(B, { key: 0 }, D(e.cqItemsOrder, (o, L) => (s(), c("div", {
        ...
        y(l) || q(o) ? (s(), c("div", {
          ...
          e.cqItemsOrder ? (s(), h(N(V.value[t.cqItemsOrder.indexOf(o)]), { key: 0 })) : g("", !0)
        ], 10, Ie)) : g("", !0)
      ], 10, _e))), 128)) : g("", !0),
      y(l) ? (s(), h(y(Q), A(P({ key: 1 }, E.value)), null, 16)) : g("", !0)
    ], 16, Ce));
  }
}), ve = ["id"], ge = ["aria-live"], qe = ["id", "aria-label", "aria-labelledby"], $e = ["aria-label"], Oe = ["id", "aria-controls", "aria-label"], ze = /* @__PURE__ */ R({
  inheritAttrs: !1,
  __name: "CoreCarousel",
  props: {
    // eslint-disable-next-line vue/require-default-prop
  ...
  setup(t) {
    const e = t, a = K(), l = typeof e.isInEditor < "u" ? e.isInEditor : M("isInEditor", G.isInEditor()), f = M("componentMapping", new T()), b = F(
      ...
      const O = {
        ...
        "data-cmp-autoplay": (a == null ? void 0 : a.autoplay) === !0 && !l ? "true" : void 0,
    ...
    return Y(
      ...
      return s(), c("div", P({
        ...
        e.controlsPrepended ? (s(), h(N(w.value), { key: 0 })) : g("", !0),
        x.value ? g("", !0) : (s(), c("div", {
          key: 1,
          ...
          e.controlsPrepended ? g("", !0) : (s(), h(N(w.value), { key: 0 })),
          v("ol", {
        ...
        y(l) ? (s(), h(y(Q), A(P({ key: 2 }, V.value)), null, 16)) : g("", !0)
      ], 16, ve);
    };
  }
}), Ge = /* @__PURE__ */ R({
...
}), Ee = ["id"], we = ["aria-label"], Pe = ["id", "aria-controls", "tabIndex"], xe = ["id", "aria-labelledby"], Ve = /* @__PURE__ */ R({
  inheritAttrs: !1,
  __name: "CoreTabs",
  props: {
    // eslint-disable-next-line vue/require-default-prop
  ...
  setup(t) {
    const e = t, a = typeof e.isInEditor < "u" ? e.isInEditor : M("isInEditor", G.isInEditor()), l = M("componentMapping", new T()), f = F(
      ...
      return a && (x["data-cq-data-path"] = e.cqPath), x;
    }), p = r(() => ({
      cqPath: e.cqPath,
      placeholderClassNames: ["new", "section"].join(" ")
    }));
    return Y(
      ...
      C.value ? g("", !0) : (s(), c("ol", {
        ...
        (s(!0), c(B, null, D(e.cqItemsOrder, (S, _) => (s(), c("li", {
          ...
          role: "tab"
        }, k(e.cqItems[S]["cq:panelTitle"]), 11, Pe))), 128))
      ], 10, we)),
      C.value ? g("", !0) : (s(!0), c(B, { key: 1 }, D(b.value, (S, _) => (s(), c("div", {
        ...
        (s(), h(N(S), A(Z({ isInEditor: !1 })), null, 16))
      ], 10, xe))), 128)),
      y(a) ? (s(), h(y(Q), A(P({ key: 2 }, p.value)), null, 16)) : g("", !0)
    ], 16, Ee));
  }
});
export {
