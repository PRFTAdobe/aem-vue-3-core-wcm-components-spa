...
const Re = {
  ...
  setup(a) {
    ...
    return (C, u) => q.value ? (i(), f(_(ce), N(S({ key: 0 }, { ...e, ..._(r) })), null, 16)) : (i(), f(j(e.styleSystemElement || "div"), {
      key: 1,
      id: e.id,
  ...
  setup(a) {
    const e = a, r = Q(), m = L("isInEditor", Y.isInEditor()), k = L("componentMapping", new ae()), q = (() => {
      try {
