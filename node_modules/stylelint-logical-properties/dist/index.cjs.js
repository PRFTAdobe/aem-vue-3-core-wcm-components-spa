...
var createReporters = function createReporters(result) {
  return {
    reportUnexpectedProperty: function reportUnexpectedProperty(decl, logicalProperty) {
      return stylelint__default['default'].utils.report({
...
var physicalValue = function physicalValue(dir) {
  ...
  return [[/^clear$/i, (_ref = {}, _defineProperty__default['default'](_ref, inline.start[dir], 'inline-start'), _defineProperty__default['default'](_ref, inline.end[dir], 'inline-end'), _ref)], [/^float$/i, (_ref2 = {}, _defineProperty__default['default'](_ref2, inline.start[dir], 'inline-start'), _defineProperty__default['default'](_ref2, inline.end[dir], 'inline-end'), _ref2)], [/^text-align$/i, (_ref3 = {}, _defineProperty__default['default'](_ref3, inline.start[dir], 'start'), _defineProperty__default['default'](_ref3, inline.end[dir], 'end'), _ref3)]];
};
        ...
        if (isAutofix) {
          if (Array.isArray(prop)) {
            ...
            var _ref4 = function () {
              ...
              if (values.length === 2) {
                var _values = _slicedToArray__default['default'](values, 2),
                    block = _values[0],
                    inline = _values[1];
              ...
              if (values.length === 3) {
                var _values2 = _slicedToArray__default['default'](values, 3),
              ...
              if (values.length === 4) {
                var _values3 = _slicedToArray__default['default'](values, 4),
...
var plugin = function plugin(method, opts, context) {
  ...
  return function (root, result) {
    // validate the method
    var isMethodValid = stylelint__default['default'].utils.validateOptions(result, ruleName, {
      actual: method,
...
var index = stylelint__default['default'].createPlugin(ruleName, plugin);
